...
class Pagamento(models.Model): # Toda classe que herda de models.Model, vira uma tabela no banco de dados.
    ...
    data_pagamento = models.DateField() # Campo para armazenar a data do pagamento.
    valor_total = models.DecimalField(max_digits=10, decimal_places=2) # Campo para armazenar o valor total do pagamento, com até 10 dígitos no total e 2 casas decimais.
